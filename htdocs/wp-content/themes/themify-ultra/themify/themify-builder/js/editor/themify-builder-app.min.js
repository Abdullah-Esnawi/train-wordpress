...
tabs(a){a.preventDefault();a.stopPropagation();a=m(a.currentTarget);const b=a.closest("ul");var d=a.data("target");const f=a.closest(".tb_modules_panel_wrap");f.find("."+a.data("hide")).hide();const e=f.find("."+d),h=f.find(".tb_no_content");0<e.length?(h.hide(),e.show()):h.show();a.closest("li").addClass("current").siblings().removeClass("current");f.find(".tb_module_panel_search_text").val("").focus().trigger("keyup");m(v).triggerHandler("tb_panel_tab_"+d,f);d=b.parent().find(".tb_ui_dropdown_label");
...
f=a.width()/2);f-=this.btn.outerWidth()/2;0>f&&(f=0);this.btn[0].classList.toggle("tb_subrow_open",0<this.clicked.parents(".sub_column").length);this.btn.css({top:d,left:f}).show();this.resize();const e=this.btn[0].getElementsByClassName("tb_predesigned_rows_container")[0];e.closest(".tb_module_panel_rows_wrap").addEventListener("scroll",c.toolbar.preDesignedRows.scrollLoadMore.bind(c.toolbar.preDesignedRows),{passive:!0});"visual"===c.mode&&(b=b.add(m("body",w.document)),"desktop"!==c.activeBreakPoint&&
(m("body",w.document).height(v.body.scrollHeight+this.btn.outerHeight(!0)),z.body.css("padding-bottom",180)));b.addClass("tb_panel_dropdown_openend");this.clicked.addClass("clicked");"desktop"===c.activeBreakPoint&&setTimeout(function(){this.btn.find(".tb_module_panel_search_text").focus()}.bind(this),50);this.hide();c.ActionBar.clear();null!==c.activeModel&&(a=t.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0],void 0!==a&&a.click());a=e.getElementsByTagName("img");0<a.length?
(a=a[a.length-1],m(a).one("load",function(){c.toolbar.preDesignedRows.masonry(e)})):c.toolbar.preDesignedRows.masonry(e);z.trigger("disableInline")},resize(){null!==this.btn&&c.Utils.addViewPortClass(this.btn[0])},hide(a){function b(){if(!0===a||!d.btn.is(":hover")){let f=z.body;null!==d.btn&&(d.btn.hide().css("width",""),d.clicked&&d.clicked[0].classList.remove("clicked"),d.clicked=null);m(v).off("click",b);m(w.document).off("click",b);"visual"===c.mode&&(f=f.add(m("body",w.document)),"desktop"!==
c.activeBreakPoint&&(m("body",w.document).height(v.body.scrollHeight),z.body.css("padding-bottom","")));f.removeClass("tb_panel_dropdown_openend")}}const d=this;if(!0===a)b();else{if("visual"===c.mode)m(w.document).on("click",b);m(v).on("click",b)}},search(a){var b=m(a.currentTarget);a=b.closest(".tb_modules_panel_wrap");const d=a.find(".tb_module_types .current").first().data("target");b=m.trim(b.val());let f=!1,e=!1,h=!1,g=!1,k=!1;"tb_module_panel_modules_wrap"===d?(f=a.find(".tb_module"),h=!0):
"tb_module_panel_rows_wrap"===d&&c.toolbar.preDesignedRows.is_init?(c.toolbar.preDesignedRows.addNewItems(b),e=a.find(".tb_ui_dropdown_label").data("active"),f=a.find(".predesigned_row"),k=!0):"tb_module_panel_library_wrap"===d&&(f=a.find(".tb_library_item"),e=a.find(".tb_library_types .current").data("target"),g=!0);if(!1!==f){const p=""===b,l=p?!1:new RegExp(b,"i");f.each(function(){if(e&&!this.classList.contains(e))return!0;let q=h?m(this).find(".module_name"):g?m(this).find(".tb_library_item_inner span"):
m(this).find(".tb_predesigned_rows_title");p||l.test(q.text())?m(this).show():m(this).hide()});p?a.removeClass("tb_module_panel_searching"):a.addClass("tb_module_panel_searching");h?a.find(".tb_module_category_content").each(function(){this.parentNode.style.display=!1!==p||m(this).find(".tb_module:visible").length?"block":"none"}):k&&c.toolbar.preDesignedRows.masonry(a[0].getElementsByClassName("tb_predesigned_rows_container")[0])}},clear(a){a.preventDefault();a.stopPropagation();a=m(this).parent().children("input").first();
0<a.length&&(a.val(""),a[0].hasAttribute("data-search")?a.trigger("keyup").focus():(a.trigger("change"),z.triggerEvent(a[0],"change")))}},help:{init(){m(".tb_help_btn",c.toolbar.$el).on("click",this.show.bind(this))},show(a){a.preventDefault();a.stopPropagation();const b=this,d=function(e){w.document.body.insertAdjacentHTML("beforeend",e);e=m("#tb_help_lightbox",w.document.body);m(".tb_help_tab_link",e).on("click",b.mainTabs.bind(b));m(".tb_player_btn",e).on("click",b.play.bind(b));m(".tb_help_menu a",
e).on("click",b.tabs.bind(b));m(".tb_close_lightbox",e).on("click",b.close.bind(b));e.slideDown()};let f=!1;t.showLoader("show");w.Themify.LoadCss(themifyBuilder.builder_url+"/css/editor/help-lightbox.css",null,null,null,function(){f||d(f);f=!0});m.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{tb_load_nonce:themifyBuilder.tb_load_nonce,action:"tb_help"},complete(){t.showLoader("spinhide")},success(e){f?d(e):f=e}})},play(a){a.preventDefault();a.stopPropagation();a=m(a.currentTarget).closest("a");
const b=a.prop("href"),d=v.createElement("iframe");d.setAttribute("frameborder","0");d.setAttribute("allow","autoplay; fullscreen");d.setAttribute("src",b+"?rel=0&showinfo=0&autoplay=1&enablejsapi=1&html5=1&version=3");a.replaceWith(d)},tabs(a){a.preventDefault();a.stopPropagation();a=m(a.currentTarget);const b=m(".tb_help_video_wrapper",w.document),d=b.find(a.attr("href")),f=d.find(".tb_player_btn");b.find(".tb_player_wrapper").removeClass("current").hide();d.addClass("current").show();a.closest("li").addClass("current").siblings().removeClass("current");
this.stopPlay();0<f.length?f.trigger("click"):this.startPlay()},execute(a,b){a.contentWindow.postMessage('{"event":"command","func":"'+b+'","args":""}',"*")},stopPlay(){const a=this;m(".tb_player_wrapper",w.document).each(function(){if(!this.classList.contains("current")){let b=m(this).find("iframe");0<b.length&&a.execute(b[0],"pauseVideo")}})},startPlay(){const a=m(".tb_player_wrapper.current",w.document).find("iframe");0<a.length&&this.execute(a[0],"playVideo")},close(a,b){a.preventDefault();a.stopPropagation();
...
d.classList.contains("tb_breakpoint_switcher")&&(a.tb_device=[b.dataset.height,b.dataset.width],a.target=d,a.currentTarget=d,this.breakpointSwitcher(a))},breakpointSwitcher(a){a.preventDefault();a.stopPropagation();let b="desktop",d=m("body",w.document);const f=this;var e=a.currentTarget;const h="visual"===c.mode&&c.iframe[0].classList.contains("tb_resizing_start"),g=c.activeBreakPoint,k=function(){f.responsive_grids(b,g);const n=function(){c.Utils.setCompactMode(v.getElementsByClassName("module_column"));
d.removeClass("tb_start_animate tb_start_change_mode").toggleClass("tb_responsive_mode","desktop"!==b).removeClass("builder-breakpoint-"+g).addClass("builder-breakpoint-"+b);z.body.triggerHandler("themify_builder_change_mode",[g,b]);"visual"===c.mode&&(c.iframe[0].style.willChange="",setTimeout(function(){"desktop"!==c.activeBreakPoint?c.Utils.calculateHeight():w.document.body.style.height="";!h&&c.scrollTo&&(m(I).add(w.document).scrollTop(c.scrollTo.offset().top),c.scrollTo=!1);z.trigger("tf_isotop_layout")},
150));c.ActionBar.disable=c.clearOnModeChange=null};"visual"===c.mode?c.Utils._onResize(!0,function(){f.iframeScroll("desktop"!==b);c.ActionBar.hoverCid=null;c.EdgeDrag.clearEdges();setTimeout(n,h?1:100)}):n()};e.classList.contains("breakpoint-tablet")?b="tablet":e.classList.contains("breakpoint-tablet_landscape")?b="tablet_landscape":e.classList.contains("breakpoint-mobile")&&(b="mobile");if(void 0!==a.tb_device||!z.body[0].classList.contains("builder-breakpoint-"+b)){var p;e="desktop"!==b?void 0!==
a.tb_device&&a.tb_device[1]?a.tb_device[1]:c.Utils.getBPWidth(b)-1:"";if(c.isPreview){var l={tablet_landscape:768,tablet:1024,mobile:667};void 0!==l[b]&&(p=void 0!==a.tb_device&&a.tb_device[0]?a.tb_device[0]:l[b])}if(g===b&&void 0!==a.originalEvent&&(e?e+"px":e)===c.iframe[0].style.width&&(p?p+"px":p)===c.iframe[0].style.height)return d.removeClass("tb_start_animate tb_start_change_mode"),!1;c.ActionBar.disable=!0;var q=[];if("visual"===c.mode){null===c.clearOnModeChange&&c.ActionBar.clear();if(!h&&
!c.isPreview){a=c.Instances.Builder[0].el.children;const n=I.innerHeight;l=function(r){if(null!==r&&void 0!==r){const u=r.getBoundingClientRect();if(0>u.bottom&&0>u.top||u.top>n)r.style.display="none",q.push(r)}};for(let r=a.length-1;-1<r;--r)l(a[r]);l(v.getElementById("headerwrap"));l(v.getElementById("footerwrap"))}d=d.add(z.body)}c.activeBreakPoint=b;d.addClass("tb_start_animate tb_start_change_mode");"visual"===c.mode?(c.iframe[0].style.willChange="width",a=w.document.getElementsByClassName("tb_toolbar_zoom_menu")[0],
a.classList.remove("tb_toolbar_zoom_active"),a.getElementsByClassName("tb_toolbar_zoom_menu_toggle")[0].dataset.zoom=100,"tablet_landscape"===b&&t.Lightbox.dockMode.get()&&(a=m(".tb_workspace_container",w.document).width(),a<e&&(e=a)),c.iframe[0].parentNode.classList.remove("tb_zoom_bg"),h?k():(w.document.body.offsetHeight,c.iframe.one("transitionend",function(){for(let n=q.length-1;-1<n;--n)q[n].style.display="";setTimeout(k,10)}),c.iframe[0].style.width=e?e+"px":"",c.iframe[0].style.height=p?p+
"px":"")):k()}},iframeScroll(a){const b=m(w.document);b.off("scroll.themifybuilderresponsive");if(a)b.on("scroll.themifybuilderresponsive",function(){I.scrollTo(0,m(this).scrollTop())})},responsive_grids(a,b){z.LoadCss(tbLocalScript.css_module_url+"responsive-column.css");const d=v.querySelectorAll(".row_inner,.subrow_inner"),f="desktop"===a,e=f||"desktop"===b;for(let k=d.length-1;-1<k;--k){var h=d[k].getAttribute("data-basecol");if(null!==h){let p=d[k].children;var g=d[k].dataset["col_"+a];let l=
p[0],q=p[p.length-1];if(!f){if("desktop"!==b){d[k].classList.remove("tb_3col");let n=d[k].getAttribute("data-col_"+b);n&&d[k].classList.remove(m.trim(n.replace("tb_3col","").replace("mobile","column").replace("tablet","column")))}if(g&&"-auto"!==g&&g!==a+"-auto"){if(g=d[k].getAttribute("data-col_"+a)){d[k].classList.add("tb_grid_classes","col-count-"+h);g=g.split(" ");for(let n=0,r=g.length;n<r;++n)d[k].classList.add(m.trim(g[n].replace("mobile","column").replace("tablet","column")))}}else d[k].classList.remove("tb_grid_classes",
"col-count-"+h)}if(e)for(let n=0,r=p.length;n<r;++n)h=p[n].dataset.w,void 0!==h&&(p[n].style.width=f?h+"%":"");"rtl"===d[k].getAttribute("data-"+a+"_dir")?(l.classList.remove("first"),l.classList.add("last"),q.classList.remove("last"),q.classList.add("first"),d[k].classList.add("direction-rtl")):(l.classList.remove("last"),l.classList.add("first"),q.classList.remove("first"),q.classList.add("last"),d[k].classList.remove("direction-rtl"))}}},Panel:{el:null,init(){this.el=c.toolbar.$el.find(".tb_toolbar_add_modules_wrap");
...
c.Mixins.Builder.rowDrop(c.toolbar.pageBreakModule.get(),m("<div>").insertAfter(b),!0);c.toolbar.pageBreakModule.countModules()},compactToolbar(){function a(){c.toolbar.$el.outerWidth()<b?w.document.body.classList.add("tb_compact_toolbar"):w.document.body.classList.remove("tb_compact_toolbar");c.toolbar.common.resize()}const b="visual"===c.mode?850:750;m(w).on("resize.compact",a);if("visual"===c.mode)w.jQuery("body").one("themify_builder_ready",a);else a()}},toggleFavoriteModule(){var a=m(this),b=
a.closest(".tb_module"),d=a.parent().data("module-slug");m.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_module_favorite",module_name:d,module_state:+!b.hasClass("favorited")},beforeSend(f){function e(h,g){function k(){if(h.length){if(g)var p=0<h.closest("#tb_module_panel_dropdown").length?c.toolbar.$el:m("#tb_module_panel_dropdown");h.removeAttr("style");var l=h.data("categories").split(","),q=h.closest(".tb_module_panel_modules_wrap"),n=q.find('.tb_module_category_content[data-category="favorite"]');
if(h.hasClass("favorited")){for(var r=l.length-1;-1<r;--r){var u=q.find('.tb_module_category_content[data-category="'+l[r]+'"]').parent();u.find(".tb_module.tb-module-"+d).css({opacity:0,transform:"scale(0.5)"}).remove();u.find(".tb_module").length||u.css({display:"none"})}n.parent().css({display:"block"});h.clone().css({opacity:0,transform:"scale(0.5)"}).appendTo(n).css({opacity:1,transform:"scale(1)"})}else for(r=l.length-1;-1<r;--r){u=q.find('.tb_module_category_content[data-category="'+l[r]+'"]');
let x=h.clone().css({opacity:0,transform:"scale(0.5)"}),y=null,B=parseInt(x[0].dataset.index);for(;0!==--B&&!(y=u.find('[data-index="'+B+'"]'),0<y.length););y?x.insertAfter(y):u.prepend(x);u.parent().css({display:"block"});x.css({opacity:1,transform:"scale(1)"})}g&&e(p.find(".tb_module.tb-module-"+d),!1);h.remove();n.find(".tb_module").length||n.parent().css({display:"none"})}}if(h.length&&!h.is(":visible"))h.toggleClass("favorited"),k();else h.css({opacity:0,transform:"scale(0.5)"}).one("transitionend",
...
"tb_lb_option_child":"tb_lb_option");for(let e=a.length-1;-1<e;--e){let h=this.parseSettings(a[e],d);!1===h||!0!==b&&""===h.v||(f[h.id]=h.v)}}return f},LayoutPart:{cache:[],undo:null,old_id:null,isReload:null,id:null,init:!1,html:null,el:null,options:null,isSaved:null,scrollTo(a,b){c.scrollTo=c.Forms.LayoutPart.el},edit(a){function b(g){c.ActionBar.clear();v.getElementById("themify_builder_content-"+themifyBuilder.post_ID).insertAdjacentHTML("afterbegin",'<div class="tb_overlay"></div>');f.addClass("tb_active_layout_part").closest(".row_inner").find(".active_module").each(function(){this.classList.contains("tb_active_layout_part")||
